          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              ...
              <a href="#" className="text-gray-400 hover:text-white transition-colors">
                ...
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 6.62 5.367 11.987 11.988 11.987s11.987-5.367 11.987-11.987C24.004 5.367 18.637.001 12.017.001zM8.449 16.988c-1.297 0-2.448-.49-3.323-1.297C4.198 14.895 3.708 13.744 3.708 12.447s.49-2.448 1.418-3.323c.875-.807 2.026-1.297 3.323-1.297s2.448.49 3.323 1.297c.928.875 1.418 2.026 1.418 3.323s-.49 2.448-1.418 3.244c-.875.807-2.026 1.297-3.323 1.297zm7.83-9.281h-1.552c-.155 0-.28-.125-.28-.28V5.875c0-.155.125-.28.28-.28h1.552c.155 0 .28.125.28.28v1.552c0 .155-.125.28-.28.28zm-7.83 1.418c-1.297 0-2.448.49-3.323 1.418-.875.807-1.418 2.026-1.418 3.323s.543 2.516 1.418 3.323c.875.928 2.026 1.418 3.323 1.418s2.448-.49 3.323-1.418c.875-.807 1.418-2.026 1.418-3.323s-.543-2.516-1.418-3.323c-.875-.928-2.026-1.418-3.323-1.418z"/>
                </svg>
              </a>
            </div>
          </div>
